...
import utils
from load_flow import DataLoader
import rnn
import lstm
...
# SGD
############
slow_start = dict(epochs=400, lr=1e-9)
learning_rate = 3e-4*mini_batch_size/32.
...
rnn_layer = partial(rnn.RecurrentLayer,
    W_in_to_hid=nn.init.Orthogonal(),
    W_hid_to_hid=nn.init.Orthogonal(),
